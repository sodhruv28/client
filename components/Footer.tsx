        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-cream-dark/70 text-sm leading-relaxed mb-6">
              Handcrafted desserts made with love in Surat. From cookie tins to
              brownie tubs, every treat is baked fresh in small batches using
              premium ingredients.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "/menu?category=cookie-tins", label: "Cookie Tins" },
                { href: "/menu?category=brownie-tubs", label: "Brownie Tubs" },
                { href: "/menu?category=hampers", label: "Gift Hampers" },
                { href: "/track", label: "Track Order" },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-cream-dark/60 hover:text-accent transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
